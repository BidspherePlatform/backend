...
create table listings (authenticity integer not null, bestseller boolean not null, starting_price float(53) not null, status smallint not null check (status between 0 and 5), end_date timestamp(6) not null, start_date timestamp(6) not null, id uuid not null, main_image_id uuid not null, seller_id uuid not null, category varchar(255) not null, description varchar(255) not null, name varchar(255) not null, sub_category varchar(255) not null, primary key (id));
